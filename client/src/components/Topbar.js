            ...
            <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item dropdown no-arrow">
                    <NavLink className="nav-link dropdown-toggle" to="#" id="userDropdown" role="button"
                        ...
                        <span className="mr-2 d-none d-lg-inline text-gray-600 small">Usuario activo</span>
                    ...
                    <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <Link className="dropdown-item" to="/login">
                            <i className="fas fa-check fa-sm fa-fw mr-2 text-gray-400"></i>
                            Iniciar sesión
                        </Link>
                        <Link className="dropdown-item" to="/register">
                            <i className="fas fa-clipboard fa-sm fa-fw mr-2 text-gray-400"></i>
                            Registrarse
                        </Link>
                        <div className="dropdown-divider"></div>
